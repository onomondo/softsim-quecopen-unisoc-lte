...
typedef struct
{
	bool scan_timeout;  ///< if set, channel time in the ql_wifiscan_option_set will be available 
} ql_wifiscan_cfg_s;
...
/*
* To set up the function, 1.if set, channel time in the ql_wifiscan_option_set will be available 
* Used before ql_wifiscan_do
*/
ql_errcode_wifi_scan_e ql_wifiscan_set_cfg(ql_wifiscan_cfg_s *cfg);
/*
