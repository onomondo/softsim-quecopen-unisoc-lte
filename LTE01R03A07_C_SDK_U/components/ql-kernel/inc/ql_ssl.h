...
#endif
#ifdef QL_SSL_ALPN_FEATURE
#define QL_SSL_ALPN_NAME_LENGTH_MAX			    255
#endif
...
#ifdef QL_SSL_PSK_FEATURE
typedef enum{
   QL_SSL_PSK_DISABLED = 0,
   QL_SSL_PSK_ENABLED  = 1,
}ql_ssl_psk_type_e;
#endif
...
typedef struct{
	...
	char			*psk_identity_ex;
    char			*psk_key_ex;

    int             psk_identity_ex_len;
    int             psk_key_ex_len;
#endif
...
#ifdef QL_SSL_PSK_FEATURE
	QL_SSL_CONF_PSK_IDENTITY_EX = 22,
	QL_SSL_CONF_PSK_KEY_EX	    = 23,
#endif

#ifdef QL_SSL_PSK_FEATURE
    QL_SSL_CONF_PSK_ENABLE      = 24,
#endif
