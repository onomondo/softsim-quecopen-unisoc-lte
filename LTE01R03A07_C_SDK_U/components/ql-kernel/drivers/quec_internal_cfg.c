...
const ql_band_size_s ql_band_size =
   /*  gsm_size    lte_size  */
    ...
    || defined (CONFIG_QL_PROJECT_DEF_EC600U_LA_AC) || defined (CONFIG_QL_PROJECT_DEF_EG915U_LA_AD) \
    || defined (CONFIG_QL_PROJECT_DEF_EC600U_EC_AD)
    {     4,          7      };
...
#if defined (CONFIG_QL_PROJECT_DEF_EG915U_LA_AB) || defined (CONFIG_QL_PROJECT_DEF_EG915U_LA_AD) \
...
const quectel_band_info_s quectel_band_tbl_lte[] =
{
    ...
    || defined (CONFIG_QL_PROJECT_DEF_EG915U_LA_AD)
    ...
    {QUEC_BAND_LTE_BAND40, RDA_BAND_LTE_BAND40},
    {QUEC_BAND_LTE_BAND41, RDA_BAND_LTE_BAND41}
#elif defined (CONFIG_QL_PROJECT_DEF_EC600U_EC_AC) || defined (CONFIG_QL_PROJECT_DEF_EC600U_EC_AD)
    {QUEC_BAND_LTE_BAND1, RDA_BAND_LTE_BAND1},
    {QUEC_BAND_LTE_BAND3, RDA_BAND_LTE_BAND3},
    {QUEC_BAND_LTE_BAND5, RDA_BAND_LTE_BAND5},
    {QUEC_BAND_LTE_BAND7, RDA_BAND_LTE_BAND7},
