...
------------     -------     -------------------------------------------------------------------------------
2024             Onomondo    Introducing an onomondo-uicc (SoftSIM) integration for Quectel devices.
...
/**
 * Handle SoftSIM filesystem profile provisioning command
...
/**
 * Handle SoftSIM filesystem reset command
 * @param cmd AT command structure
 */
