...
#if 0
    //如果测试这个接口的话，需要修改ql_wifiscan_option_set中的channel_time为其他值（大于120ms），比如200ms
    ql_wifiscan_cfg_s wifiscan_cfg = {0};
    wifiscan_cfg.scan_timeout = true;

    ql_wifiscan_set_cfg(&wifiscan_cfg);
#endif
