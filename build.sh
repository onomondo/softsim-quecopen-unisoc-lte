...
################
echo "------------------------------------------------------------"
# Copy the SoftSIM integration source code to the QuecOpen SDK
...
################
# UTILIZE vSIM QUECOPEN CORE IMAGES
################
...
# ./build_all.sh new EG912UEAL_AC softsim_debug_v1.0.0 VOLTE
# ./build_all.sh new EG915UEU_AB softsim_debug_v1.0.0 VOLTE
# ./build_all.sh new EG915ULA_AB softsim_debug_v1.0.0 VOLTE
